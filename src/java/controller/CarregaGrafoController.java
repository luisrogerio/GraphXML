...
public class CarregaGrafoController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (grafoCarregado != null) {
            ...
            response.sendRedirect("GeraInformacoesGrafo");
            //getServletContext().getRequestDispatcher("/GerarInformacoesGrafo").forward(request, response);

        } else {
            request.setAttribute("mensagem", "O Grafo foi carregado vazio! :/");
            getServletContext().getRequestDispatcher("/index.jsp").forward(request, response);
        }
    }
