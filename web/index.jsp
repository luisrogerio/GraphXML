...
<html>
    <head>
        ...
        <body>
            ...
            <form action="${pageContext.request.contextPath}/GrafoController" method="post">
                <br />
                <div id="formulario">
                <p> <label for="nomeGrafo" ><input type="text" id="nomeGrafo" size="20" name="nomeGrafo" value="" placeholder="Nome do Grafo" /></label></p>
